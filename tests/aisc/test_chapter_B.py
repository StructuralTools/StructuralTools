...
def test_table_B4_1b_10_lamb_p():
    ...
    assert string == r"\lambda_{pf} &= 0.38 \cdot \sqrt{\frac{E}{F_y}} = 0.38 \cdot \sqrt{\frac{29000\ \mathrm{ksi}}{50\ \mathrm{ksi}}} &= 9.152"
...
def test_table_B4_1b_10_lamb_r():
    ...
    assert string == r"\lambda_{rf} &= \sqrt{\frac{E}{F_y}} = \sqrt{\frac{29000\ \mathrm{ksi}}{50\ \mathrm{ksi}}} &= 24.083"
...
def test_table_B4_1b_15_lamb_p():
    ...
    assert string == r"\lambda_{pw} &= 3.76 \cdot \sqrt{\frac{E}{F_y}} = 3.76 \cdot \sqrt{\frac{29000\ \mathrm{ksi}}{50\ \mathrm{ksi}}} &= 90.553"
...
def test_table_B4_1b_15_lamb_r():
    ...
    assert string == r"\lambda_{rw} &= 5.7 \cdot \sqrt{\frac{E}{F_y}} = 5.7 \cdot \sqrt{\frac{29000\ \mathrm{ksi}}{50\ \mathrm{ksi}}} &= 137.274"
