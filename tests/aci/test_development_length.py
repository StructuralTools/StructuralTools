...
def test_straight_bar_factors_1():
    ...
    assert results[0] == r"""$$ \begin{aligned}
...
def test_straight_bar_min():
    ...
    markdown, l_d = aci.development_length.straight_bar(
        rebar=rebar,
        concrete=concrete,
        c_c=3*unit.inch,
        s=12*unit.inch,
...
$$ \begin{aligned}
    ...
    K_{tr} &= \frac{40 \cdot A_{tr}}{s \cdot n}
        = \frac{40 \cdot 0\ \mathrm{in}^{2}}{12\ \mathrm{in} \cdot 1}
        &= 0.0\ \mathrm{in}
    \\[10pt]
    c_b &= \operatorname{min}\left(c_c + \frac{d_b}{2} ,\ \frac{s}{2}\right)
        = \operatorname{min}\left(3\ \mathrm{in} + \frac{0.5\ \mathrm{in}}{2} ,\ \frac{12\ \mathrm{in}}{2}\right)
        &= 3.25\ \mathrm{in}
    \\[10pt]
    l'_d &= \left(\frac{3 \cdot f_y \cdot \operatorname{min}\left(\psi_t \cdot \psi_e ,\ 1.7\right) \cdot \psi_s \cdot \psi_g}{40 \cdot \lambda \cdot \sqrt{f'_c \cdot \mathrm{psi}} \cdot \left(\frac{c_b + K_{tr}}{d_b}\right)}\right) \cdot d_b
        \\
        &= \left(\frac{3 \cdot 60000\ \mathrm{psi} \cdot \operatorname{min}\left(1 \cdot 1 ,\ 1.7\right) \cdot 1 \cdot 1}{40 \cdot 1 \cdot \sqrt{4000\ \mathrm{psi} \cdot \mathrm{psi}} \cdot \left(\frac{3.25\ \mathrm{in} + 0.0\ \mathrm{in}}{0.5\ \mathrm{in}}\right)}\right) \cdot 0.5\ \mathrm{in}
        \\
        &= 5.473\ \mathrm{in}
    \\[10pt]
    l_d &= \operatorname{max}\left(l'_d ,\ 12\ \mathrm{in}\right)
        = \operatorname{max}\left(5.473\ \mathrm{in} ,\ 12\ \mathrm{in}\right)
        &= 12\ \mathrm{in}
\end{aligned} $$"""
...
$$ \begin{aligned}
    \\[10pt]
    K_{tr} &= \frac{40 \cdot A_{tr}}{s \cdot n}
        = \frac{40 \cdot 0.79\ \mathrm{in}^{2}}{12\ \mathrm{in} \cdot 4}
        &= 0.658\ \mathrm{in}
    \\[10pt]
    c_b &= \operatorname{min}\left(c_c + \frac{d_b}{2} ,\ \frac{s}{2}\right)
        = \operatorname{min}\left(3\ \mathrm{in} + \frac{1.0\ \mathrm{in}}{2} ,\ \frac{12\ \mathrm{in}}{2}\right)
        &= 3.5\ \mathrm{in}
    \\[10pt]
    l'_d &= \left(\frac{3 \cdot f_y \cdot \operatorname{min}\left(\psi_t \cdot \psi_e ,\ 1.7\right) \cdot \psi_s \cdot \psi_g}{40 \cdot \lambda \cdot \sqrt{f'_c \cdot \mathrm{psi}} \cdot \left(\frac{c_b + K_{tr}}{d_b}\right)}\right) \cdot d_b
        \\
    ...
    \\[10pt]
    l_d &= \operatorname{max}\left(l'_d ,\ 12\ \mathrm{in}\right)
        = \operatorname{max}\left(17.111\ \mathrm{in} ,\ 12\ \mathrm{in}\right)
        &= 17.111\ \mathrm{in}
\end{aligned} $$"""
...
$$ \begin{aligned}
    ...
    l'_d &= \left(\frac{3 \cdot f_y \cdot \operatorname{min}\left(\psi_t \cdot \psi_e ,\ 1.7\right) \cdot \psi_s \cdot \psi_g}{40 \cdot \lambda \cdot \sqrt{f'_c \cdot \mathrm{psi}} \cdot \left(\frac{c_b + K_{tr}}{d_b}\right)}\right) \cdot d_b
        \\
        &= \left(\frac{3 \cdot 80000\ \mathrm{psi} \cdot \operatorname{min}\left(1.3 \cdot 1.2 ,\ 1.7\right) \cdot 1 \cdot 1.15}{40 \cdot 0.75 \cdot \sqrt{4000\ \mathrm{psi} \cdot \mathrm{psi}} \cdot \left(\frac{3.5\ \mathrm{in} + 0.0\ \mathrm{in}}{1.0\ \mathrm{in}}\right)}\right) \cdot 1.0\ \mathrm{in}
        \\
        &= 64.836\ \mathrm{in}
    \\[10pt]
    l_d &= \operatorname{max}\left(l'_d ,\ 12\ \mathrm{in}\right)
        = \operatorname{max}\left(64.836\ \mathrm{in} ,\ 12\ \mathrm{in}\right)
        &= 64.836\ \mathrm{in}
\end{aligned} $$"""
...
def test_standard_hook_min():
    concrete = materials.Concrete(4000*unit.psi)
    rebar = materials.Rebar(4)
    markdown, l_dh = aci.development_length.standard_hook(
        rebar=rebar,
        concrete=concrete,
        c_c_side=3*unit.inch,
        s=12*unit.inch,
