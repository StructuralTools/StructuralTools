...
calc_phi_transition = Template(r"""$$$$ \begin{aligned}
    & \text{Since, } \left(\epsilon_{ty} < \epsilon_t < \epsilon_{ty} + 0.003 \Leftarrow $epsilon_ty < $epsilon_t < $epsilon_ty003\right):
        \\[10pt]
        & \qquad \phi = 0.65 + 0.25 \cdot \frac{\epsilon_t - \epsilon_{ty}}{0.003} = 0.65 + 0.25 \cdot \frac{$epsilon_t - $epsilon_ty}{0.003} &= $phi
\\[10pt] \end{aligned} $$$$""")
...
moment_capacity = Template(r"""
    $$$$ \begin{aligned}
        a &= \frac{n \cdot A_b \cdot f_y}{0.85 \cdot f'_c \cdot b} = \frac{$n \cdot $A_b \cdot $f_y}{0.85 \cdot $f_prime_c \cdot $b} &= $a
        \\[10pt]
        M_n &= n \cdot A_b \cdot f_y \cdot \left(d - \frac{a}{2}\right) = $n \cdot $A_b \cdot $f_y \cdot \left($d - \frac{$a}{2}\right) &= $M_n
        \\[10pt]
        \epsilon_t &= 0.003 \cdot \left(\frac{\beta_1 \cdot d_t}{a} - 1\right) = 0.003 \cdot \left(\frac{$beta_1 \cdot $d_t}{$a} - 1\right) &= $epsilon_t
    \\[10pt] \end{aligned} $$$$
    $phi_latex
""")
