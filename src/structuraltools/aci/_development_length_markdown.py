...
straight_bar_factors = Template(r"""$$$$ \begin{aligned}
    $lamb_template
    \\[10pt]
    $psi_g_template
    \\[10pt]
...
straight_bar = Template(r"""$factors_markdown
$$$$ \begin{aligned}
    \\[10pt]
...
standard_hook_factors = Template(r"""$$$$ \begin{aligned}
    $lamb_template
    \\[10pt]
    $psi_e_template
    \\[10pt]
...
standard_hook = Template(r"""$factors_markdown
$$$$ \begin{aligned}
