...
moment_plastic = Template(r"""\end{aligned} $$$$ $$$$ \begin{aligned}
    & \text{Since, } \left(\frac{L_d \cdot d}{t^2} \leq \frac{0.08 \cdot E}{F_y} \Leftarrow $length \leq $short\right): & M_n &= M_p
\end{aligned} $$$$ $$$$ \begin{aligned}""")

moment_ltb_short = Template(r"""& \text{Since, } \left(\frac{0.08 \cdot E}{F_y} < \frac{L_b \cdot d}{t^2} \leq \frac{1.9 \cdot E}{F_y} \Leftarrow $short < $length \leq $long\right):
    \\[10pt]
...
moment_ltb_long = Template(r"""& \text{Since, } \left(\frac{L_d \cdot d}{t^2} > \frac{1.9 \cdot E}{F_y} \Leftarrow $length > $long\right):
    \\[10pt]
...
moment_capacity = Template(r"""$$$$ \begin{aligned}
    M_p &= \operatorname{min}\left(F_y \cdot Z_x ,\ 1.5 \cdot F_y \cdot S_x\right)
        = \operatorname{min}\left($F_y \cdot $Z_x ,\ 1.5 \cdot $F_y \cdot $S_x\right)
        &= $M_p
    \\[10pt]
    $M_n_template
\end{aligned} $$$$""")

moment_minor_plastic = Template(r"""\end{aligned} $$$$ $$$$ \begin{aligned}
    & \text{Since, } \left(\frac{L_d \cdot t}{d^2} \leq \frac{0.08 \cdot E}{F_y} \Leftarrow $length \leq $short\right): & M_n &= M_p
\end{aligned} $$$$ $$$$ \begin{aligned}""")

moment_minor_ltb_short = Template(r"""& \text{Since, } \left(\frac{0.08 \cdot E}{F_y} < \frac{L_b \cdot t}{d^2} \leq \frac{1.9 \cdot E}{F_y} \Leftarrow $short < $length \leq $long\right):
    \\[10pt]
...
moment_minor_ltb_long = Template(r"""& \text{Since, } \left(\frac{L_d \cdot t}{d^2} > \frac{1.9 \cdot E}{F_y} \Leftarrow $length > $long\right):
    \\[10pt]
...
moment_capacity_minor = Template(r"""$$$$ \begin{aligned}
    M_p &= \operatorname{min}\left(F_y \cdot Z_y ,\ 1.5 \cdot F_y \cdot S_y\right)
        = \operatorname{min}\left($F_y \cdot $Z_y ,\ 1.5 \cdot $F_y \cdot $S_y\right)
        &= $M_p
    \\[10pt]
    $M_n_template
\end{aligned} $$$$""")
